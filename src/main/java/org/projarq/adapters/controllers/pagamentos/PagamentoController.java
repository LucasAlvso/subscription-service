...
public class PagamentoController
{
    ...
    public @NonNull RespostaPagamentoDTO registrarPagamento(@RequestBody @NonNull RegistrarPagamentoDTO registrarPagamentoDTO)
    {
	    ...
	    catch (IllegalArgumentException e)
	    {
		    ...
		    return new RespostaPagamentoDTO(EStatusPagamento.INCORRECT_AMOUNT, subscription.get().fimVigencia(), 0.0);
        }
        catch (IllegalStateException e)
        {
            ...
            return new RespostaPagamentoDTO(EStatusPagamento.INCORRECT_AMOUNT, subscription.get().fimVigencia(), registrarPagamentoDTO.valorPago());
        }
    }
